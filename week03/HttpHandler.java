...
import org.example.week02.HttpUtilDemo;
...
public class HttpHandler extends ChannelInboundHandlerAdapter {
    ...
    private void handlerTest(FullHttpRequest fullRequest, ChannelHandlerContext ctx, String body) {
        ...
        try {
            ...
            String s = headers.get(HeaderHttpRequestFilter.HEAD_KEY);
            value = HttpUtilDemo.sendGetByUrl("http://localhost:8801/",HeaderHttpRequestFilter.HEAD_KEY,s);
